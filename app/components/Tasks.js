    ...
    <div className="p-8 flex flex-wrap gap-6 w-full bg-gradient-to-br from-slate-950 via-gray-900 to-slate-950">
      ...
      >
        ...
        <div className="flex justify-between items-start">
          <div>
            <h2 className="text-xl font-bold text-white">Learn Next.js</h2>

            <p className="text-sm text-gray-400 mt-1">Today • 08:00 PM</p>
          </div>
        ...
        >
          <p className="text-gray-300 text-sm leading-relaxed">
            Complete server actions, authentication and database integration for
